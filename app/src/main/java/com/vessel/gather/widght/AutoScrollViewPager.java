...
public class AutoScrollViewPager extends RelativeLayout {
    ...
    public AutoScrollViewPager(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        switch (pointLayoutStr) {
            case RIGHT_POINT:
                view = LayoutInflater.from(context).inflate(R.layout.widght_layout_point_right_text, null);
                break;
            case CENTER_POINT:
                view = LayoutInflater.from(context).inflate(R.layout.widght_layout_point_center_text, null);
                break;
            default:
                view = LayoutInflater.from(context).inflate(R.layout.widght_layout_point_center_text, null);
                break;
